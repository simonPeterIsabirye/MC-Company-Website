    ...
    <nav className="flex items-center justify-between py-6 px-4 lg:px-12">
      <div className="flex items-center gap-2">
        ...
        <div className="flex flex-col">
          ...
          <span className="text-[9px] lg:text-[10px] tracking-[0.2em] text-gray-300 uppercase">
            Solutions
          </span>
        </div>
      </div>
      ...
      <div className="hidden lg:flex gap-8 text-sm text-gray-300">
        ...
        <a
          href="https://medium.com/@medcreativelabs"
          target="_blank"
      ...
      <button
        className="lg:hidden text-white transition-transform duration-200 hover:scale-110 active:scale-90"
      ...
      {isOpen && (
        <div className="absolute top-20 right-4 w-60 bg-blue-950 p-6 flex flex-col gap-4 lg:hidden z-20 text-center rounded-xl shadow-lg">
          ...
          <a
            href="https://medium.com/@mindcrescent-labs"
            target="_blank"
            rel="noopener noreferrer"
